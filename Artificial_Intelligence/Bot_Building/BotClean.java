 ...
 * to move the bot to clean all the dirty cells. Complete the function next_move
 * that takes in 3 parameters posr, posc being the co-ordinates of the bot's
 * current position and board which indicates the board state to print the bot's
 * next move.
 *
